...
Plugin generuje xml feed pre obchod pod správou woocommerce na platforme wordpress. Plugin generuje xml feed pre portál Heureka.sk a Heureka.cz.
...
Pro verzia (platená) dokáže vygenerovať na jeden xml feed spolu až 999 produktov!!! Viete si nastaviť dodatočne voliteľné údaje, vďaka ktorým zákazníci produkt skôr nájdu, získajú viac informácii a rýchlejšie vykonajú preklik na vašu stránku.
